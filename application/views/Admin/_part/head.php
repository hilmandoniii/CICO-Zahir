...
<html lang="en">
    ...
    <head>
        ...
        <!-- plugin css -->
        <link href="<?= base_url() ?>assets/tmp-admin/css/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?= base_url() ?>assets/table/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
