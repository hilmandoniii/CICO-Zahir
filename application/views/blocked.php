            ...
            <div class="container">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="<?= base_url('Auth'); ?>"> Login dlu yappp ! </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-10 col-xl-8">
                        <div>
                            <img src="<?= base_url() ?>assets/tmp-admin/images/error-img.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <!-- end row -->
                </div>
